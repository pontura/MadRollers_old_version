...
Shader "Hidden/VacuumShaders/Curved World/One Directional Light/UV Scroll/Blend/Detail"
{
	Properties 
	{
		//Tag
	...
	SubShader 
	{
		Tags { "RenderType"="CurvedWorld_Local_Opaque" 
		       "CurvedWorldTag"="Global/One Directional Light/UV Scroll/Blend/Detail" 
	...
	{
		Tags { "RenderType"="CurvedWorld_Local_Opaque" 
		       "CurvedWorldTag"="Global/Unlit/UV Scroll/Blend/Detail" 
			   "CurvedWorldBakedKeywords"="" 
			 }
		LOD 150

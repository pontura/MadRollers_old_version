...
Shader "Hidden/VacuumShaders/Curved World/One Directional Light/UV Scroll/Specular"
{
	Properties    
	{    
		//Tag  
	...
	SubShader 
	{
		Tags { "RenderType"="CurvedWorld_Local_Opaque" 
		       "CurvedWorldTag"="Global/One Directional LightUV Scroll/Specular" 
	...
	{
		Tags { "RenderType"="CurvedWorld_Local_Opaque" 
		       "CurvedWorldTag"="Global/Unlit/UV Scroll/Texture" 
			   "CurvedWorldBakedKeywords"="" 
			 }
		LOD 100

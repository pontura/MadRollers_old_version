...
Shader "Hidden/VacuumShaders/Curved World/One Directional Light/UV Scroll/Blend/Decal"
{
	Properties 
	{
		//Tag 
	...
	SubShader 
	{
		Tags { "RenderType"="CurvedWorld_Local_Opaque" 
		       "CurvedWorldTag"="Global/One Directional Light/UV Scroll/Blend/Decal" 
	...
	{
		Tags { "RenderType"="CurvedWorld_Local_Opaque" 
		       "CurvedWorldTag"="Global/Unlit/UV Scroll/Blend/Decal" 
			   "CurvedWorldBakedKeywords"="" 
			 }
		LOD 150

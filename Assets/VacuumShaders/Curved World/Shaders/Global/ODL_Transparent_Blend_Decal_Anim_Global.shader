...
Shader "Hidden/VacuumShaders/Curved World/One Directional Light/Transparent/UV Scroll/Blend/Decal"
{
	Properties 
	{
		//Tag
	...
	SubShader 
	{
		Tags { "Queue"="Transparent" 
		       ...
		       "CurvedWorldTag"="Global/One Directional Light/Transparent/UV Scroll/Blend/Decal" 
	...
	SubShader 
	{
		Tags { "Queue"="Transparent+1" 
		       "IgnoreProjector"="True" 
			   "RenderType"="Transparent" 
		       "CurvedWorldTag"="Global/Unlit/Transparent/UV Scroll/Blend/Decal" 
			   "CurvedWorldBakedKeywords"="" 
			 }
		LOD 150

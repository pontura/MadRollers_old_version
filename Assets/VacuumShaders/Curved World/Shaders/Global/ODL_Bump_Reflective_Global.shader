...
Shader "Hidden/VacuumShaders/Curved World/One Directional Light/Reflective/Bumped Diffuse"
{
	Properties    
	{          
		//Tag              
	...
	SubShader 
	{
		Tags { "RenderType"="CurvedWorld_Global_Opaque" 
		       "CurvedWorldTag"="Global/One Directional Light/Reflective/Bumped Diffuse" 
	...
	{
		Tags { "RenderType"="CurvedWorld_Global_Opaque" 
		       "CurvedWorldTag"="Global/Unlit/Reflective/Texture" 
			   "CurvedWorldBakedKeywords"="" 
			 }
		LOD 150

...
Shader "Hidden/VacuumShaders/Curved World/One Directional Light/Transparent/UV Scroll/Blend/Detail"
{
	Properties 
	{
		//Tag
		...
		_V_CV_DetailTex_scrollSpeed_U("    Detail Scroll Speed U", float) = 0
		_V_CV_DetailTex_scrollSpeed_V("    Detail Scroll Speed V", float) = 0
	...
	SubShader 
	{
		Tags { "Queue"="Transparent" 
		       ...
		       "CurvedWorldTag"="Global/One Directional Light/Transparent/UV Scroll/Blend/Detail" 
	...
	SubShader 
	{
		Tags { "Queue"="Transparent" 
		       "IgnoreProjector"="True" 
			   "RenderType"="Transparent" 
		       "CurvedWorldTag"="Global/Unlit/Transparent/UV Scroll/Blend/Detail" 
			   "CurvedWorldBakedKeywords"="" 
			 }
		LOD 150

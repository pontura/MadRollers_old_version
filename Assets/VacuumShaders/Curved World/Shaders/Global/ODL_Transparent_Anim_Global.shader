...
Shader "Hidden/VacuumShaders/Curved World/One Directional Light/Transparent/UV Scroll/Diffuse"
{
	Properties 
	{
		//Tag
	...
	SubShader 
	{
		Tags { "Queue"="Transparent" 
			   ...
			   "CurvedWorldTag"="Global/One Directional Light/Transparent/UV Scroll/Diffuse" 

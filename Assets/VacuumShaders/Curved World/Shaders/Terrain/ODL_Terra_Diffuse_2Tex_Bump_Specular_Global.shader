...
Shader "Hidden/VacuumShaders/Curved World/One Directional Light/Terrain/2Tex Bumped Specular"
{
	Properties    
	{          
		//Tag               
	...
	SubShader 
	{
		Tags { "RenderType"="CurvedWorld_Local_Opaque" 
		       "CurvedWorldTag"="Global/One Directional Light/Terrain/2Tex Bumped Specular" 
	...
	{
		Tags { "RenderType"="CurvedWorld_Local_Opaque" 
		       "CurvedWorldTag"="Global/Unlit/Terrain/2Tex" 
			   "CurvedWorldBakedKeywords"="" 
			 }
		LOD 150

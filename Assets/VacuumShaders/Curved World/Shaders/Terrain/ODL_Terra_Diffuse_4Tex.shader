...
Shader "VacuumShaders/Curved World/One Directional Light/Terrain/4Tex Diffuse"
{
	Properties    
	{          
		//Tag               
	...
	SubShader 
	{
		Tags { "RenderType"="CurvedWorld_Local_Opaque" 
		       "CurvedWorldTag"="One Directional Light/Terrain/4Tex Diffuse" 
	...
	{
		Tags { "RenderType"="CurvedWorld_Local_Opaque" 
		       "CurvedWorldTag"="Unlit/Terrain/4Tex" 
			   "CurvedWorldBakedKeywords"="" 
			 }
		LOD 150

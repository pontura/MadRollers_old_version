...
Shader "Hidden/VacuumShaders/Curved World/One Directional Light/Terrain/2Tex Bumped Diffuse"
{
	Properties    
	{          
		//Tag               
	...
	SubShader 
	{
		Tags { "RenderType"="CurvedWorld_Local_Opaque" 
		       "CurvedWorldTag"="Global/One Directional Light/Terrain/2Tex Bumped Diffuse" 

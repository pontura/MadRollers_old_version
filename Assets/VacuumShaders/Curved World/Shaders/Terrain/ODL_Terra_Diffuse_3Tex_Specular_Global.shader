...
Shader "Hidden/VacuumShaders/Curved World/One Directional Light/Terrain/3Tex Specular"
{
	Properties    
	{          
		//Tag               
	...
	SubShader 
	{
		Tags { "RenderType"="CurvedWorld_Local_Opaque" 
		       "CurvedWorldTag"="Global/One Directional Light/Terrain/3Tex Specular" 
	...
	{
		Tags { "RenderType"="CurvedWorld_Local_Opaque" 
		       "CurvedWorldTag"="Global/Unlit/Terrain/3Tex" 
			   "CurvedWorldBakedKeywords"="" 
			 }
		LOD 150

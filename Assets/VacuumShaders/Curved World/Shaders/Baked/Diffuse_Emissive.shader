...
Shader "VacuumShaders/Curved World/Baked/Diffuse_Emissive"
{
	Properties 
	{ 
		//Tag
	...
	SubShader 
	{
		Tags { "RenderType"="CurvedWorld_Global_Opaque" 
			   ...
			   "CurvedWorldBakedKeywords"="V_CW_SELF_ILLUMINATED_ON;V_CW_GLOBAL_FOG_ON"
			 }
		LOD 200
		...
		Pass
	    {
			...
			#define V_CW_SELF_ILLUMINATED_ON
			

			#define V_CW_GLOBAL_FOG_ON

			#define V_CW_GLOBAL_IBL_OFF

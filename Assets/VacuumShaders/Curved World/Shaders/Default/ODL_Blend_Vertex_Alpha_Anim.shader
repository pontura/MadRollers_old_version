...
Shader "VacuumShaders/Curved World/One Directional Light/UV Scroll/Blend/Vertex Alpha"
{
	Properties    
	{          
		//Tag              
	...
	SubShader 
	{
		Tags { "RenderType"="CurvedWorld_Local_Opaque" 
		       "CurvedWorldTag"="One Directional Light/UV Scroll/Blend/Vertex Alpha" 
	...
	{
		Tags { "RenderType"="CurvedWorld_Local_Opaque" 
		       "CurvedWorldTag"="Unlit/UV Scroll/Blend/Vertex Alpha" 
			   "CurvedWorldBakedKeywords"="" 
			 }
		LOD 100

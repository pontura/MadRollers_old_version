...
Shader "VacuumShaders/Curved World/One Directional Light/Reflective/Bumped Diffuse"
{
	Properties    
	{          
		//Tag              
	...
	SubShader 
	{
		Tags { "RenderType"="CurvedWorld_Local_Opaque" 
		       "CurvedWorldTag"="One Directional Light/Reflective/Bumped Diffuse" 
	...
	{
		Tags { "RenderType"="CurvedWorld_Local_Opaque" 
		       "CurvedWorldTag"="Unlit/Reflective/Texture" 
			   "CurvedWorldBakedKeywords"="" 
			 }
		LOD 150

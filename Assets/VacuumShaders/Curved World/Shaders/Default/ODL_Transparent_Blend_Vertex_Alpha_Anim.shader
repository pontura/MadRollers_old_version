...
Shader "VacuumShaders/Curved World/One Directional Light/Transparent/UV Scroll/Blend/Vertex Alpha"
{
	Properties    
	{          
		//Tag              
	...
	SubShader 
	{
		Tags { "Queue"="Transparent" 
		       ...
		       "CurvedWorldTag"="One Directional Light/Transparent/UV Scroll/Blend/Vertex Alpha" 
	...
	SubShader 
	{
		Tags { "Queue"="Transparent" 
		       "IgnoreProjector"="True" 
			   "RenderType"="Transparent" 
		       "CurvedWorldTag"="Unlit/Transparent/UV Scroll/Blend/Vertex Alpha" 
			   "CurvedWorldBakedKeywords"="" 
			 }
		LOD 100

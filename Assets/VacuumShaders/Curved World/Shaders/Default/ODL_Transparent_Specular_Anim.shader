...
Shader "VacuumShaders/Curved World/One Directional Light/Transparent/UV Scroll/Specular"
{
	Properties 
	{
		//Tag
	...
	SubShader 
	{
		Tags { "Queue"="Transparent+1" 
			   ...
			   "CurvedWorldTag"="One Directional Light/Transparent/UV Scroll/Specular" 
	...
	SubShader 
	{
		Tags { "Queue"="Transparent+1" 
		       "IgnoreProjector"="True" 
			   "RenderType"="Transparent" 
			   "CurvedWorldTag"="Unlit/Transparent/UV Scroll/Texture" 
			   "CurvedWorldBakedKeywords"="" 
			 }
		LOD 100

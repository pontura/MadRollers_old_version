...
Shader "VacuumShaders/Curved World/One Directional Light/UV Scroll/Blend/Decal"
{
	Properties 
	{
		//Tag 
	...
	SubShader 
	{
		Tags { "RenderType"="CurvedWorld_Local_Opaque" 
		       "CurvedWorldTag"="One Directional Light/UV Scroll/Blend/Decal" 
	...
	{
		Tags { "RenderType"="CurvedWorld_Local_Opaque" 
		       "CurvedWorldTag"="Unlit/UV Scroll/Blend/Decal" 
			   "CurvedWorldBakedKeywords"="" 
			 }
		LOD 150

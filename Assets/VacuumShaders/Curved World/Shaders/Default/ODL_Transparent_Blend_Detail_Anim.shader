...
Shader "VacuumShaders/Curved World/One Directional Light/Transparent/UV Scroll/Blend/Detail"
{
	Properties 
	{
		//Tag
	...
	SubShader 
	{
		Tags { "Queue"="Transparent" 
		       ...
		       "CurvedWorldTag"="One Directional Light/Transparent/UV Scroll/Blend/Detail" 
	...
	SubShader 
	{
		Tags { "Queue"="Transparent" 
		       "IgnoreProjector"="True" 
			   "RenderType"="Transparent" 
		       "CurvedWorldTag"="Unlit/Transparent/UV Scroll/Blend/Detail" 
			   "CurvedWorldBakedKeywords"="" 
			 }
		LOD 150

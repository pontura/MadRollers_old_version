...
Shader "VacuumShaders/Curved World/One Directional Light/Transparent/UV Scroll/Diffuse"
{
	Properties 
	{
		//Tag
	...
	SubShader 
	{
		Tags { "Queue"="Transparent" 
			   ...
			   "CurvedWorldTag"="One Directional Light/Transparent/UV Scroll/Diffuse" 

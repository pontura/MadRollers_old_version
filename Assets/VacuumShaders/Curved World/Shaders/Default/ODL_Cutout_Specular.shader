...
Shader "VacuumShaders/Curved World/One Directional Light/Cutout/Specular"
{
	...
	SubShader 
	{
		Tags { "Queue"="AlphaTest" 
			   ...
			   "RenderType"="CurvedWorld_Local_TransparentCutout" 
		...
		//ShadowCaster
		UsePass "Hidden/VacuumShaders/Curved World/ShadowPass_Cutout/SHADOWCASTER"

		//ShadowCollector
		UsePass "Hidden/VacuumShaders/Curved World/ShadowPass_Cutout/SHADOWCOLLECTOR"
